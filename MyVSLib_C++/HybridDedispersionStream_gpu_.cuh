...
int createOutputFDMT_gpu(fdmt_type_* parr_fdmt_out, cufftComplex* pffted_rowsignal, cufftComplex* pcarrCD_Out
	, cufftComplex* pcarrTemp, const unsigned int LEnChunk, const unsigned int N_p, fdmt_type_* parr_fdmt_inp
...
inline int calcTreadsForMean_and_Disp(unsigned const int nCols)
{
