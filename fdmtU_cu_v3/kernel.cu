...
int main(int argc, char** argv)
{
	...
	//// declare constants
	//const int IMaxDT = 128;// iMaxDT;
	//const int IImgrows = 128;// iImRows;
	//const int IImgcols = pow(2, 20) / IImgrows; ;// iImCols;
	//const float VAlFmin = 1200;// val_fmin;
	//const float VAlFmax = 1600;// val_fmax;
